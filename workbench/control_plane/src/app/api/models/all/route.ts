...
const LITELLM_MODELS: { id: string; label: string; group: string; provider: string | null }[] = [
  ...
  { id: "openrouter/deepseek/deepseek-r1-0528",        label: "DeepSeek R1 0528 (latest reasoning)", group: "LiteLLM — OpenRouter", provider: "openrouter" },
  { id: "openrouter/deepseek/deepseek-chat-v3-0324",  label: "DeepSeek V3 0324",         group: "LiteLLM — OpenRouter", provider: "openrouter" },
  { id: "openrouter/deepseek/deepseek-chat",           label: "DeepSeek (latest)",        group: "LiteLLM — OpenRouter", provider: "openrouter" },
