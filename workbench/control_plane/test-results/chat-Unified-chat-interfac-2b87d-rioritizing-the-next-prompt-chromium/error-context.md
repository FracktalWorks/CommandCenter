...
- Name: chat.spec.ts >> Unified chat interface >> supports steer mode by interrupting the current response and prioritizing the next prompt
- Location: e2e\chat.spec.ts:255:7
