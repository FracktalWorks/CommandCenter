...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, import('command-center-branding/lib/browser/command-center-branding-frontend-module'));
        await load(container, import('command-center-config-plane/lib/browser/command-center-config-plane-frontend-module'));
