...
class EmailMessage(BaseModel):
    """Minimal envelope we need for triage. Maps cleanly from a Microsoft
    Graph `GET /users/{user}/messages` response (see WBS 1.3)."""
    ...
    subject: str = ""
    snippet: str = ""               # bodyPreview from Graph API message
