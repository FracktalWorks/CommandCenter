...
- Name: chat.spec.ts >> Unified chat interface >> creates a named-agent session in the same UI and surfaces missing integrations
- Location: e2e\chat.spec.ts:166:7
