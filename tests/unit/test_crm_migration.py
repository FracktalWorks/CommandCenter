...
# ═══════════════════════════════════════════════════════════════════════════
#
# Derived from the CRM spine migration, not the sync one: the guard reads
# CREATE TABLE bodies, and `zoho_dirty` arrives as an ALTER in the second
# migration on a column no request body may name.
#
