...
export const CONFIG_PLANE_SERVICE_PATH = '/services/command-center-config-plane';

export const ConfigPlaneService = Symbol('ConfigPlaneService');
...
export interface ConfigPlaneService {
    ...
    // --- Agent directives (standing behavioural rules) -------------------
    ...
    // --- Feedback (thumbs up/down ratings for agent responses) ----------
...
// ---------------------------------------------------------------------------
// Tools  (user-defined wrappers around integration API endpoints)
// ---------------------------------------------------------------------------
...
export interface ToolDefinition {
    ...
    // --- Script-tool fields (only used when kind === 'script') -----------
