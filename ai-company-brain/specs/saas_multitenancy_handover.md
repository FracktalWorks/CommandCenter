...
READ IN THIS ORDER, FULLY, BEFORE TOUCHING ANYTHING:
  1. ai-company-brain/specs/saas_multitenancy_handover.md   (this runbook — order + gates)
  2. ai-company-brain/specs/saas_multitenancy.md            (§0.1, §0.9, §1, §5.1, §11)
  3. ai-company-brain/specs/saas_multitenancy_implementation.md  (SQL + seam shapes)
