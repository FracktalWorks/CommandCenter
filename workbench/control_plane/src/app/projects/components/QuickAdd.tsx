...
/**
 * Projects · the inline group-context add (WS-27y).
 *
 * One control, three surfaces: a board column (or lane cell), a list group,
 * a calendar day. Collapsed it is a quiet "+ Add"; open it is a title box
