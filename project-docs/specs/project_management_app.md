...
> **WS-27bd narrowed to two of five items — §11.28, 2026-08-11**) ·
...
> 🟢 **WS-27bd (NARROWED to items 5 and 2) BUILT 2026-08-11, on branch
> `ws-27bd-context-menu-row-state`, NOT merged and NOT deployed** (§11.28) — the right-click
...
> palette already uses" is **corrected in §11.28**: `lib/commands.ts` is the page registry and
...
### 11.28 WS-27bd (narrowed) — the right-click menu, promoted; per-row pending (built 2026-08-11)
