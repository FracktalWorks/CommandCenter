...
> ⚠️ **⏸ PARKED WITH ITS PARENT (D25.7) (2026-08-10 consolidation, D26).** No work dispatches from
> this document — companion contract of `drawio_integration.md`. The active plan is `project-docs/work_plan.md` §2;
