...
# ── Split-out sub-routers ────────────────────────────────────────────────────
# Imported LAST so their routes register on `router` after every shared helper
# above is defined. Names the scheduler/tests import from gateway.routes.email
# are re-exported here so the public surface is unchanged.
from gateway.routes import email_digest as _email_digest  # noqa: E402
from gateway.routes.email_digest import (  # noqa: E402,F401
    _generate_digest,
    _maybe_send_digest,
)
