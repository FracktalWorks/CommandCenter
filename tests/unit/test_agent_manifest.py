...
#: config.json.
# The two assistants are LIVE personal agents: migration 137 quarantined their
...
# per-agent, orchestrator last (the default chat agent: most traffic, most
# visible if recall regresses).
