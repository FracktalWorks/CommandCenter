...
## Purpose
Docker Compose, Postgres schema, LiteLLM config (legacy — no longer needed; LLM routing is via gateway /v1 endpoint).
...
- LiteLLM env file (`litellm.env`) is auto-generated by deploy.sh; never commit real keys
