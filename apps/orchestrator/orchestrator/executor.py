...
- **emit_generative_ui(ui)** — Render a rich, interactive UI element inline in the chat: pass a JSON component TREE (card/table/keyValue/badge/callout/buttons — data, not code) and it renders as real UI instead of plain text. Use when a structured visual answer beats prose (a summary card, comparison table, status dashboard, or a set of action buttons).
