...
# The ORIGINAL per-agent office avatars (generated by build_sheets.py). Their packed
# assets live in the SAME public/character-library/ folder as everyone else; we just
# fold them into the manifest so there is ONE character library the whole app reads.
OFFICE_SRC = PUB
OFFICE_WEB = "/character-library"
OFFICE_META = {
